...
export default function ShippingScreen() {
  ...
  return (
    <div className="shippingScreenContainer">
        ...
        <input placeholder="Full Name" className="screen-inputs" value={name} onChange={(e) => setName(e.target.value)}/> 
        <input placeholder="Address" className="screen-inputs" value={address}  onChange={(e) => setAddress(e.target.value)} /> 
        <input placeholder="City" className="screen-inputs" value={city} onChange={(e) => setCity(e.target.value)} /> 
        <input placeholder="Postal Code" className="screen-inputs" value={postalCode} onChange={(e) => setPostalCode(e.target.value)}  /> 
        <input placeholder="Country" className="screen-inputs" value={country} onChange={(e) => setCountry(e.target.value)} />
        {inputErr !== "" && (
            <>
        ...
        <button onClick={() => validateShipping()} className="log-button">Continue</button>
